...
def test_klaytn_signFeeDelegatedValueTransfer(backend, navigator, test_name):
    ...
    with sol.send_async_sign_transaction(message, INS.INS_SIGN_VALUE_TRANSFER, P1_FEE_DELEGATED):
        navigator.navigate_until_text_and_compare(NavInsID.RIGHT_CLICK,
                                                  [NavInsID.BOTH_CLICK],
                                                  "Approve",
                                                  ROOT_SCREENSHOT_PATH,
...
def test_klaytn_signFeeDelegatedValueTransferMemo(backend, navigator, test_name):
    ...
    with sol.send_async_sign_transaction(message, INS.INS_SIGN_VALUE_TRANSFER_MEMO, P1_FEE_DELEGATED):
        navigator.navigate_until_text_and_compare(NavInsID.RIGHT_CLICK,
                                                  [NavInsID.BOTH_CLICK],
                                                  "Approve",
                                                  ROOT_SCREENSHOT_PATH,
...
def test_klaytn_signFeeDelegatedSmartContractDeploy(backend, navigator, test_name):
    ...
    message: bytes = bytearray.fromhex(
        "058000002c80002019800000008000000080000000f846b83ff83d1119850ba43b7400830493e0940ee56b604c869e3792c99e35c1c424f88f87dc8a01946694d467b419b36fb719e851cd65d54205df75558568656c6c6f8220198080")
    with sol.send_async_sign_transaction(message, INS.INS_SIGN_SMART_CONTRACT_DEPLOY, P1_FEE_DELEGATED):
        navigator.navigate_until_text_and_compare(NavInsID.RIGHT_CLICK,
                                                  [NavInsID.BOTH_CLICK],
                                                  "Approve",
                                                  ROOT_SCREENSHOT_PATH,
...
def test_klaytn_signFeeDelegatedSmartContractExecution(backend, navigator, test_name):
    ...
    with sol.send_async_sign_transaction(message, INS.INS_SIGN_SMART_CONTRACT_EXECUTION, P1_FEE_DELEGATED):
        navigator.navigate_until_text_and_compare(NavInsID.RIGHT_CLICK,
                                                  [NavInsID.BOTH_CLICK],
                                                  "Approve",
                                                  ROOT_SCREENSHOT_PATH,
...
def test_klaytn_signFeeDelegatedCancel(backend, navigator, test_name):
    ...
    with sol.send_async_sign_transaction(message, INS.INS_SIGN_CANCEL, P1_FEE_DELEGATED):
        navigator.navigate_until_text_and_compare(NavInsID.RIGHT_CLICK,
                                                  [NavInsID.BOTH_CLICK],
                                                  "Approve",
                                                  ROOT_SCREENSHOT_PATH,
