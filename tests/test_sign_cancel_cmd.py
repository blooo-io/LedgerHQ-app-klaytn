...
def test_sign_cancel_tx(firmware, backend, navigator, test_name):
    ...
    # This is the apdu of the transaction to sign
    # Here is the transaction's content:
    # encode(
        # encode(
            # type: 0x38,
            # nonce: 0x19 #25
        ...
        # 0
    # )
    transaction_hex = "e03800003e058000002c80002019800000000000000000000000e8a2e13819850ba43b7400830493e0946e93a3acfbadf457f29fb0e57fa42274004c32ea8203e98080"
