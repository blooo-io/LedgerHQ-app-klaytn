[![Ensure compliance with Ledger guidelines](https://github.com/LedgerHQ/app-klaytn/actions/workflows/guidelines_enforcer.yml/badge.svg)](https://github.com/LedgerHQ/app-klaytn/actions/workflows/guidelines_enforcer.yml) [![Build and run functional tests using ragger through reusable workflow](https://github.com/LedgerHQ/app-klaytn/actions/workflows/build_and_functional_tests.yml/badge.svg?branch=master)](https://github.com/LedgerHQ/app-klaytn/actions/workflows/build_and_functional_tests.yml)

# Ledger Klaytn Application

This is a klaytn application which can be forked to start a new project for the Ledger Nano S/X/SP and Stax.
...
* Open a terminal and clone `app-klaytn` with `git clone git@github.com:LedgerHQ/app-klaytn.git`.
* Open the `app-klaytn` folder with VSCode.
...
If so, This klaytn will help you get started.
